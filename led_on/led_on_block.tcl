...
################################################################
# This is a generated script based on design: led_on_block
#
...
# source led_on_block_script.tcl
...
proc create_root_design { parentCell } {
  ...
  # Create instance: led_on, and set properties
  set block_name led_on
  set block_cell_name led_on
  if { [catch {set led_on [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
...
\
  ...
  connect_bd_net -net led_on_0_led [get_bd_ports led_0] [get_bd_pins led_on/led]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins led_on/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
