...
################################################################
# This is a generated script based on design: ledblink
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: led_blinker, and set properties
  set block_name led_blinker
  set block_cell_name led_blinker
  if { [catch {set led_blinker [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $led_blinker eq "" } {
...
\
  ...
  connect_bd_net -net led_blinker_0_o_led [get_bd_ports led] [get_bd_pins led_blinker/o_led]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins led_blinker/sysclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
